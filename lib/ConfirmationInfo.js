...
var ConfirmationInfo = module.exports = function (cic_xml, msg_id, trx_id, cmd_id) {
  ...
  // custom cic values:
  this.confirm_code = $('catalogueItemConfirmationStatus > confirmationStatusCode').text() 
  this.confirm_desc = $('catalogueItemConfirmationStatus > confirmationStatusCodeDescription').text() 
