...
function InfoStream(process) {

  if (!(this instanceof InfoStream)) return new InfoStream(process, options)
...
util.inherits(InfoStream, stream.Transform);

InfoStream.prototype._transform = function(chunk, encoding, done) {
