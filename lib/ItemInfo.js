...
// this constructor should be passed the tradeItem xml element
var ItemInfo = module.exports = function (ti_xml, msg_info) {
  ...
  // need these other IDs? not yet present in msg_info
  //item.trx_id = trx_id
  //item.cmd_id = cmd_id
  //item.doc_id = doc_id
