...
var MessageInfo = module.exports = function (msg_xml, config) {
  ...
  clear_msg_data(msg_info) // resetting all properties to empty strings and arrays
...
console.log('root first/0th child: ' + root.children[0].constructor.name)
  ...
  if (msg_info.msg_type == 'catalogueItemNotification') {
    ...
    $('catalogueItemNotificationIdentification').each(function () {
      ...
      $('catalogueItem > tradeItem', this.parent).each(function () {
        ...
        console.log('found trade item: ' + ti_xml)
        var item = new ItemInfo(ti_xml, msg_info.msg_id, trx_id, cmd_id, doc_id)
