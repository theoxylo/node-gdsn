...
var clear_msg_data = function (msg_info) {
  ...
  msg_info.msg_type_list = ['registryPartyDataDump'
                           ...
                           ,'gS1Response' // includes CIRR and BPRR 
                           ,'gS1Exception']
