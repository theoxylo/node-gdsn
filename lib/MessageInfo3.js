...
module.exports = function MessageInfo3(xml, config) {
  ...
  msg_info.subscriptions = [] // for CIS, RFCIN

  msg_info.publication   = ''
  msg_info.publications  = [] // for CIP
...
*/
    ...
    $('tradeItem').each(function () {
      var the_gtin = $('tradeItem tradeItemIdentification gtin', this).first().text()  // need "tradeItem" to skip others
