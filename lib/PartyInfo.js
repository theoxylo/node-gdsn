...
var PartyInfo = module.exports = function (party_xml, msg_id, trx_id, cmd_id) {
  ...
  party.source_dp = $('informationProvider, transmittingDataPool, registeringParty').first().text()
  //if (!party.source_dp) party.source_dp= $('registeringParty').text()
  //if (!party.source_dp) party.source_dp= $('transmittingDataPool').text()
