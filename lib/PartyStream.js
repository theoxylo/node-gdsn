...
function PartyStream(gdsn) {
  if (!(this instanceof PartyStream)) return new PartyStream(gdsn)
...
PartyStream.prototype.getEachPartyFromStream = function (is, cb) {
  ...
  var msgInfo  = new Header(this._gdsn.getMessageInfoFromString)
  var elements = new Elements('registryPartyDataDumpDetail')
