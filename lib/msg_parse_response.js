...
module.exports = parse_response = function ($, msg, sh) {
  ...
  if (msg.msg_type == 'gS1Response'                       // 3.1, includes gS1Exception
   || msg.msg_type == 'GDSNResponse'                      // 2.8, includes gDSNException
   || msg.msg_type == 'partyRegistrationResponse'         // 2.8 and 3.1, PRR response to BPR
   || msg.msg_type == 'catalogueItemRegistrationResponse' // 2.8 and 3.1, CIRR response to RCI
  ) {
