  ...
  return function (ti_28_xml) {
    ...
    $28('tradeItemDescriptionInformation').each(function () { // should be only 1
      ...
      $28('descriptionShort > description', this).each(function () {
          ...
          var name = $28('shortText', this).text()
          $31('tradeItemDescriptionInformation > brandNameInformation').before('<descriptionShort languageCode="' + lang + '">' + name + '</descriptionShort>')
      })
      $28('functionalName > description', this).each(function () {
          var lang = $28('languageISOCode', this).text()
          var name = $28('shortText', this).text()
          $31('tradeItemDescriptionInformation > brandNameInformation').before('<functionalName languageCode="' + lang + '">' + name + '</functionalName>')
      })
      $28('invoiceName > description', this).each(function () {
          var lang = $28('languageISOCode', this).text()
          var name = $28('shortText', this).text()
          $31('tradeItemDescriptionInformation > brandNameInformation').before('<invoiceName languageCode="' + lang + '">' + name + '</invoiceName>')
      })
    })
