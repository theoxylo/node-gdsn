...
module.exports = function (cheerio, gdsn) {
  ...
  function populate_variant_allergen_info($28, $31, $tii, variant) {
    ...
    if (!added) $31('allergen_information\\:allergenInformationModule', $extension).remove()
  ...
  function populate_variant_diet_info($28, $31, $tii, variant) {
    ...
    var added = false // added at least one occurrence?
    ...
    if (!added) $31('diet_information\\:dietInformationModule', $extension).remove()
  ...
  function populate_variant_ingredient_info($28, $31, $tii, variant) {
    ...
    if (!added) $31('food_and_beverage_ingredient\\:foodAndBeverageIngredientModule', $extension).remove()
