...
module.exports = function (cheerio, gdsn) {
  ...
  return function (ti_28_xml) {
    ...
    data_carrier_info($28, $31, $ext)
    
    if ($28_fbInfo) {
      diet_info($28, $31, $ext, $28_fbInfo)
  ...
  function data_carrier_info($28, $31, $ext) {
    log('data_carrier_info')
  ...
  function create_additional_variants($28, $31) {
    ...
    $28('foodAndBeverageInformation').each(function () {
      ...
      var $tii = $31('<tradeItemInformation/>')
