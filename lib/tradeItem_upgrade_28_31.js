...
module.exports = function (cheerio, gdsn) {
  ...
  return function (ti_28_xml) {
    ...
    food_and_bev_preparation($28, $31, $ext)
  ...
  function food_and_bev_preparation($28, $31, $extension) {
    ...
    var $info = $31('<preparationServing/>')
    $info.append($31('<preparationInstructions/>').attr('languageCode', 'en').text('prepare as directed'))
    $info.append($31('<preparationTypeCode/>').text('BAKE'))
    $mod.append($info)
    $extension.append($mod)
  ...
  function marketing_info($28, $31, $extension) {
    ...
    $info.append($31('<tradeItemFeatureBenefit/>').attr('languageCode', 'en').text('this is some feature benefit text'))
    $mod.append($info)
    $extension.append($mod)
  } // end marketing_info
  ...
  function trade_item_handling($28, $31, $extension) {
    ...
    $info.append($31('<handlingInstructionsDescription/>').attr('languageCode', 'en').text('handle carefully at all times'))
    $mod.append($info)
    $extension.append($mod)
  ...
  function trade_item_lifespan($28, $31, $extension) {
    ...
    $info.append($31('<minimumTradeItemLifespanFromTimeOfArrival/>').text('9'))
    $mod.append($info)
    $extension.append($mod)
