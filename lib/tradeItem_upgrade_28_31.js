...
module.exports = function (cheerio, gdsn) {
  ...
  function food_and_bev_ingredients($28, $31, $extension, variant) {
    if (!variant) return
  ...
  function food_and_bev_preparation($28, $31, $extension, variant) {
    ...
    if (num_serv || $prep) $extension.append($mod)

  } // end food_and_bev_preparation

  function food_and_bev_properties($28, $31, $extension) {
  ...
  function marketing_info($28, $31, $extension) {
    log('marketing_info')
  ...
  function safety_data_sheet($28, $31, $extension) {
  ...
  function trade_item_handling($28, $31, $extension) {
    log('trade_item_handling')
    var mod_has_data = false
    var $info = $31('<tradeItemHandlingInformation/>')

    $28('tradeItemHandlingInformation > clampPressure').first().each(function () {
      mod_has_data = true
      var uom   = $28(this).attr('unitOfMeasure')
      var value = $28('value', this).text()
  ...
  function trade_item_hierarchy($28, $31, $extension) {
    ...
    $info.append($31('<quantityOfInnerPack/>').text('33'))
    $mod.append($info)
    $extension.append($mod)
  } // end trade_item_hierarchy

  function trade_item_lifespan($28, $31, $extension) {
  ...
  function trade_item_temperature($28, $31, $extension) {
  ...
  function create_additional_variants($28, $31) { // additional variants can only have allergen, diet, ingredient, and nutrient info
    ...
    $28('foodAndBeverageInformation').each(function () {
      ...
      food_and_bev_ingredients($28, $31, $extension, this)

      food_and_bev_preparation($28, $31, $extension, this)
