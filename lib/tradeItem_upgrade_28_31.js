...
module.exports = function (cheerio, gdsn) {
  ...
  function populate_variant_allergen_info($28, $31, $tii, variant) {
    ...
    $28('foodAndBeverageAllergyRelatedInformation', variant).each(function () {
      var spec_agency = ''
      var spec_name   = ''
  ...
  function populate_variant_diet_info($28, $31, $tii, variant) {
    ...
    $28('foodAndBeverageDietRelatedInformation', variant).each(function () {
        ...
        $31('dietTypeDescription', $new_diet).remove()

        var type    = $28('foodAndBeverageDietTypeInformation > dietTypeCode', this)
        if (type) $31('dietTypeInformation > dietTypeCode', $new_diet).text(value)
        else      $31('dietTypeInformation > dietTypeCode', $new_diet).remove()

        var subtype = $28('foodAndBeverageDietTypeInformation > dietTypeSubcode', this)
        if (type) $31('dietTypeInformation > dietTypeSubcode', $new_diet).text(value)
        else      $31('dietTypeInformation > dietTypeSubcode', $new_diet).remove()

        var agency = $28('dietCertificationAgency', this)
        if (agency) $31('dietTypeInformation > dietCertification > certificationAgency', $new_diet).text(agency)
        else        $31('dietTypeInformation > dietCertification > certificationAgency', $new_diet).remove()

        var value  = $28('dietCertificationNumber', this)
        if (value) $31('dietTypeInformation > dietCertification > certification > certificationValue', $new_diet).text(value)
        else       $31('dietTypeInformation > dietCertification > certification', $new_diet).remove()

        if (!agency && !value) $31('dietTypeInformation > dietCertification', $new_diet).remove()
    })
    $diet_info.first().remove()
