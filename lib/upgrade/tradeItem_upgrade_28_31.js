...
module.exports = function (cheerio, gdsn) {
  ...
  function copy_avp ($28, ti28, $31) {
    ...
    $28('value[name]', ti28).each(function () {
      ...
      if (name == 'isAllergenRelevantDataProvided')     return // allergenInformationModule allergenRelevantDataProvided?
      if (name == 'isNutrientRelevantDataProvided')     return // ??
      ...
      if (name == 'nutrientValueDerivation') name += 'Code'
