...
api.getPartyInfo = function (raw_xml, msg_info) {
  ...
  info.gln           = getNodeData($doc, '/registryPartyDataDumpDetail/registryParty/informationProviderOfParty/gln')
  ...
  info.country       = getNodeData($doc, '/registryPartyDataDumpDetail/registryParty/registryPartyInformation/registryPartyNameAndAddress/countryCode/countryISOCode')
  info.data_pool_gln = getNodeData($doc, '/registryPartyDataDumpDetail/registryPartyDates/registeringParty')
